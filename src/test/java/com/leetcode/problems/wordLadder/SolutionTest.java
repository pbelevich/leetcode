...
public class SolutionTest {
    ...
    public void ladderLength() throws Exception {
        assertEquals(2, SOLUTION.ladderLength("hot", "dot", Collections.singletonList("dot")));
        ...
        assertEquals(2, SOLUTION.ladderLength("a", "c", Arrays.asList("a", "b", "c")));
        assertEquals(11, SOLUTION.ladderLength("cet", "ism", Arrays.asList(
        ...
        assertEquals(11, SOLUTION.ladderLength("sand", "acne", Arrays.asList(
